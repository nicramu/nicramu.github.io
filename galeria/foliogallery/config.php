...
$thumbs_per_page   = '3000';        	 // number of thumnbnails per page -- effective only if $inline_albums = FALSE or $inline_thumbs = FALSE 

/***** gallery settings *****/
$inline_albums     = FALSE;        // TRUE will display album thumbs in the main gallery in one line scroller, FALSE will display all albums in gallery
...
/***** album settings *****/
$inline_thumbs	   = FALSE;        // TRUE will display thumbs in album in one line scroller, FALSE will display all thumbs 
$thumb_captions    = TRUE;        // TRUE will display file names or captions for each thumb in album, FALSE will display no captions
$sort_files        = 'name';    // newest: sort by modified date. oldest: sort by oldest. name: sort alphabetically. namereverse: sort alphabetically in reverse
